...
public abstract class AbstractIT {
    ...
    @BeforeClass public static void setup() throws IOException {
        ...
        ClusterConfig clusterConfig = new ClusterConfig().readFrom(Files.newInputStream(CLUSTER_CONFIG_PATH));
        CLUSTER_1 = clusterConfig.getClusters().get(0);
        CLUSTER_2 = clusterConfig.getClusters().get(1);
